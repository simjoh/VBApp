        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="last_name" id="last-name" value="{{ old('last_name') }}" autocomplete="family-name"
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-4">
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email Confirmation</label>
                    <div class="mt-2">
                        <input id="email-confirm" name="email-confirm" type="email" required autocomplete="email"
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input type="text" name="tel" id="tel" autocomplete="tel-level2"
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input type="text" name="club" id="club" autocomplete="tel-level2"
                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                <div class="sm:col-span-4">
                    <div class="flex flex-wrap mx-3 mb-2">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input maxlength="4"
                                   ...
                                   name="year" id="year" type="text" placeholder="YYYY">
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input maxlength="2"
                                   class="block  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                   name="month" id="month" type="text" placeholder="MM">
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input maxlength="2"
                                   class="block  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                   name="day" id="day" type="text" placeholder="DD">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-full">
                    <label for="extra-info" class="block text-sm font-medium leading-6 text-gray-900">Special Dietary
                        Requirements</label>
                    <div class="mt-2">
                    ...
                    <fieldset>
                        ...
                        <div class="mt-6 space-y-6">
                            ...
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="lunch_box" class="font-medium text-gray-900">Lunch box - Baggböle Manor, Sunday 16 June,
                                        15:00.</label>
                                </div>
                            </div>
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="bag_drop" class="font-medium text-gray-900">Bag drop Umeå Plaza - Baggböle Manor, Sunday
                                        16 June, 15:00.</label>
                                </div>
                            </div>
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="long_term_parking" class="font-medium text-gray-900">Long-term parking - Baggböle Manor,
                            ...
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="buffet_dinner" class="font-medium text-gray-900">Buffet Dinner- Brännland Inn, Sunday 16
                                        June, 19:00.</label>
                                </div>
                            </div>
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="midsummer" class="font-medium text-gray-900">Swedish Midsummer Celebration - Friday 20
                                        June, 12:00.</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="mt-6 space-y-6">
                            <div class="flex items-center gap-x-3">
                                ...
                                <label for="female-core" class="block text-sm font-medium leading-6 text-gray-900">MSR Jersey - Female,
                                    Core Fittet, 680 SEK (-25%)</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="female-tor" name="jersey" value="1008" type="radio"
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                <label for="female-tor" class="block text-sm font-medium leading-6 text-gray-900">MSR Jersey - Female,
                                    Tor, 980 SEK (-25%)</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="male-core" name="jersey" value="1009" type="radio"
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                <label for="male-core" class="block text-sm font-medium leading-6 text-gray-900">MSR Jersey - Male, Core
                                    Fittet, 680 SEK (-25%)</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="male-tor" name="jersey" value="1010" type="radio"
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                <label for="male-tor" class="block text-sm font-medium leading-6 text-gray-900">MSR Jersey - Male, Tor,
                                    980 SEK (-25%)</label>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="mt-6 space-y-6">
                            <div class="flex items-center gap-x-3">
                                <input id="driver" name="productID" value="1011" type="radio"
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                <label for="driver" class="block text-sm font-medium leading-6 text-gray-900">Driver looking for
                                    passengers</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="vehicle" name="productID" value="1012" type="radio"
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                <label for="vehicle" class="block text-sm font-medium leading-6 text-gray-900">Passenger looking for
                                    vehicle</label>
                            </div>
                        </div>
                    </fieldset>
