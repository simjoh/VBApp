...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '84108ea9-5831-4551-9dc1-4518c7a08da2'; // Make sure this is unique
            $event->title = 'Täby 400 MälarenXL';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-06-14 06:59:59';
            ...
            $routeDetail->height_difference = 1694; // Hardcoded value in meters
            $routeDetail->start_time = '06:00';
            $routeDetail->start_place = 'Circle K, Kemistvägen 2';
            $routeDetail->pay_link = 'Swish 1233610086';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49430190';
            $routeDetail->save();
