...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->description = '';
            $event->startdate = '2025-05-04';
            $event->enddate = '2025-05-04';
            ...
            $eventconfiguration->registration_opens = '2025-05-02 00:00:00';
            $eventconfiguration->registration_closes = '2025-05-02 23:59:59';
            ...
            $routeDetail->height_difference = 1759; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48599976';
            $routeDetail->save();
