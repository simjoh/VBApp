...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Moturs';
            $event->description = '';
            $event->startdate = '2025-04-17';
            $event->enddate = '2025-04-17';
            ...
            $eventconfiguration->registration_opens = '2025-04-16 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-16 23:59:00';
            ...
            $routeDetail->height_difference = 1936; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/37270122';
            $routeDetail->save();
