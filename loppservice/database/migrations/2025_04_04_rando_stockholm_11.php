...
return new class extends Migration
{
    ...
    public function up(): void
    {
         if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '1b740479-8951-498e-9202-31e8cd60add4'; // Make sure this is unique
            $event->title = 'Bromma 300';
            $event->description = '';
            $event->startdate = '2025-05-24';
            $event->enddate = '2025-05-24';
            ...
            $eventconfiguration->registration_opens = '2025-05-24 00:00:00';
            $eventconfiguration->registration_closes = '2025-05-24 08:59:59';
            ...
            $routeDetail->height_difference = 2818; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Shell, Ulvsundavägen 71';
            $routeDetail->pay_link = 'Swish 1230149641';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49928132';
            $routeDetail->save();
