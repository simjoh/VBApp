...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'Vamos ala Öregrund 300';
            $event->description = '';
            ...
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/barkarby-300';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/barkarby-300/#gpx';
            $routeDetail->save();
