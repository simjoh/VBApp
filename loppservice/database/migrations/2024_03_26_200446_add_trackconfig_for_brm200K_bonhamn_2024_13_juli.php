...
return new class extends Migration {
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            $event = new Event();
            $event->event_uid = 'f5a5b805-0991-4c4b-a4b8-6b330d5d49ad';
            $event->title = "BRM 200K BÖNHAMN - 13 Juli";
            $event->description = 'Startplats: Ullånger, OKQ8. Starttid: 11:00. Cykelintresset bjuder på avslutningsfika.';
            $event->startdate = '2024-07-13';
            $event->enddate = '2024-07-13';
            $event->completed = false;
            $event->embedid = 3100349179201448984;
            ...
            $event = new Event();
            $event->event_uid = 'aea52ef2-a2cb-4493-8137-45cf2ead0337';
            $event->title = "TEST - BRM 200K BÖNHAMN - 13 Juli";
            $event->description = 'Startplats: Ullånger, OKQ8. Starttid: 11:00. Cykelintresset bjuder på avslutningsfika.';
            $event->startdate = '2024-07-13';
            $event->enddate = '2024-07-13';
            $event->completed = false;
