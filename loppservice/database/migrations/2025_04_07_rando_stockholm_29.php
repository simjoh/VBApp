...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '10c4a319-bbe6-43fc-a02d-e017d3d99d91'; // Make sure this is unique
            $event->title = 'Barkarby 300 Tour de Africa';
            $event->description = '';
            $event->startdate = '2025-09-06';
            $event->enddate = '2025-09-06';
            ...
            $eventconfiguration->registration_closes = '2025-09-05 07:59:59';
            ...
            $routeDetail->height_difference = 1693; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50325934';
            $routeDetail->save();
