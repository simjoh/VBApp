...
return new class extends Migration
{
    ...
    public function up(): void
    {
      //  if (App::isProduction()) {
            ...
            $event->title = 'BP 140 VÄSTERBOTTEN BREVET';
            $event->description = '';
            ...
            $routeDetail->distance = 140; // 200 km
            $routeDetail->height_difference = 926; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3274853380471301208';
            $routeDetail->save();
