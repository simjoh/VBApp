...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '6b5b1f8c-5370-4353-94a6-63620a7a2e7b'; // Make sure this is unique
            $event->title = 'Bromma 400';
            $event->description = '';
            $event->startdate = '2025-07-05';
            $event->enddate = '2025-07-05';
            ...
            $eventconfiguration->registration_opens = '2025-07-05 00:00:00';
            $eventconfiguration->registration_closes = '2025-07-05 07:59:59';
            ...
            $routeDetail->height_difference = 3234; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48473465';
            $routeDetail->save();
