...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '79dccd08-204e-4d96-89e7-35950b1e3d28'; // Make sure this is unique
            $event->title = 'BRM 600 Örebro Norra';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-06-26 23:59:00';
            ...
            $routeDetail->height_difference = 5421; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50081423';
            $routeDetail->save();
