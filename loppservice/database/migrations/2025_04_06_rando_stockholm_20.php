...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'e254b6cb-050b-4026-a03d-0802d27bf7b2'; // Make sure this is unique
            $event->title = 'Uppsala 200 Brukscykling';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-09 08:59:59';
            ...
            $routeDetail->height_difference = 1616; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50100210';
            $routeDetail->save();
