...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'Nyagammal grusrunda';
            $event->description = '';
            ...
            $routeDetail->height_difference = 2415; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3314660852289741660';
            $routeDetail->save();
