...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'Fredagsmys 200';
            $event->description = '';
            $event->startdate = '2025-05-02';
            $event->enddate = '2025-05-02';
            ...
            $routeDetail->start_place = 'CircleK, Kemistvägen 2';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/taby-200-fredagsmys';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/taby-200-fredagsmys/#gpx';
            $routeDetail->save();
