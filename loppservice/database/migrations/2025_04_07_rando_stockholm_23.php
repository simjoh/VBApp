...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '464b7784-962e-4a4d-80e8-07194e3e682f'; // Make sure this is unique
            $event->title = 'Barkarby 1000 Vi drar till Sälen';
            $event->description = '';
            $event->startdate = '2025-06-05';
            $event->enddate = '2025-06-07';
            ...
            $eventconfiguration->registration_closes = '2025-06-04 19:59:59';
            ...
            $routeDetail->distance = 1000; // 200 km
            $routeDetail->height_difference = 10455; // Hardcoded value in meters
            $routeDetail->start_time = '20:00';
            $routeDetail->start_place = 'Welcome Hotel, Notarievägen 5';
            $routeDetail->pay_link = 'Swish 123 227 96 51';
	    $routeDetail->name = $event->title;

            // Simplified description without start time/place info
            $routeDetail->description = 'OBS! Kvällsstart 20:00!';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50272580';
            $routeDetail->save();
