...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '3520bd92-1f00-4c89-8438-b7c321036882'; // Make sure this is unique
            $event->title = 'BRM 400 ÅMLIDEN';
            $event->description = '';
            $event->startdate = '2025-07-12';
            $event->enddate = '2025-07-13';
            ...
            $eventconfiguration->registration_opens = '2025-04-01 00:00:00';
            $eventconfiguration->registration_closes = '2025-07-11 21:59:59';
            ...
            $routeDetail->distance = 400; // 400 km
            $routeDetail->height_difference = 2857; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Broparken, Umeå';
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3378323829433131378';
            $routeDetail->save();
