...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'b29793df-5e95-49f0-ad84-d76b015232cb'; // Make sure this is unique
            $event->title = 'BRM 600 Uppsala';
            $event->description = '';
            $event->startdate = '2025-08-23';
            $event->enddate = '2025-08-24';
            ...
            $eventconfiguration->registration_closes = '2025-08-22 06:00:00';
            ...
            $routeDetail->height_difference = 11041; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Scandic Hotell Nord, Uppsala';
            $routeDetail->pay_link = 'Swish 123 202 9999';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/51213692';
            $routeDetail->save();
