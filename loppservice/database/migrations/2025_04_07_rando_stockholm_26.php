...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'dad64553-0584-49b6-96a4-35bb1b467873'; // Make sure this is unique
            $event->title = 'Uppsala 400 Dra åt Hälsingland';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-06-13 06:59:59';
            ...
            $routeDetail->height_difference = 1949; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50100219';
            $routeDetail->save();
