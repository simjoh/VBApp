...
return new class extends Migration
{
    ...
    public function up(): void
    {
     //   if (App::isProduction()) {
            ...
            $event->title = 'Lund-Österlen';
            $event->description = '';
            $event->startdate = '2025-05-29';
            $event->enddate = '2025-05-29';
            ...
            $routeDetail->height_difference = 1180; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Circle K Lund, Magistratsvägen';
            $routeDetail->pay_link = 'https://milslukaren.se/?page_id=42';
	       $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/27167005';
            $routeDetail->save();
