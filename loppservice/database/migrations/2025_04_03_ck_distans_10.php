...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Torsby';
            $event->description = '';
            $event->startdate = '2025-08-09';
            $event->enddate = '2025-05-09';
            $event->completed = false;
            $event->embedid = '';
            $event->event_type = 'BRM'; // BRM = Brevet Randonneurs Mondiaux

            // Step 2: Hardcode county ID (Värmlands län)
            $event->county_id = 13; // Hardcoded county ID - change this later
            ...
            $eventconfiguration->registration_opens = '2025-08-07 00:00:00';
            $eventconfiguration->registration_closes = '2025-08-07 23:59:59';
            ...
            $routeDetail->height_difference = 1599; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Valbergsstugan, Torsby Sportcenter';
            $routeDetail->pay_link = 'Swish 0702822108' ;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/46529987';
            $routeDetail->save();
