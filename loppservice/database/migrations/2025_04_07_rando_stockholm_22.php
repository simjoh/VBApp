...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '0b6d085f-8a08-4fe2-a24c-0be4e7fc8719'; // Make sure this is unique
            $event->title = 'Barkarby 600 Rättvik ToR';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-23 07:59:59';
            ...
            $routeDetail->height_difference = 7365; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50266036';
            $routeDetail->save();
