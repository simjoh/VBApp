...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'Twin Peaks';
            $event->description = '';
            $event->startdate = '2025-04-05';
            $event->enddate = '2025-04-05';
            $event->completed = false;
            $event->embedid = '';
            $event->event_type = 'BRM'; // BRM = Brevet Randonneurs Mondiaux

            // Step 2: Hardcode county ID (Västmanland)
            $event->county_id = 15; // Hardcoded county ID - change this later
            ...
            $eventconfiguration->registration_opens = '2025-04-04 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-04 23:59:59';
            ...
            $routeDetail->height_difference = 1688; // Hardcoded value in meters
            $routeDetail->start_time = '08:30';
            $routeDetail->start_place = 'Circle K, Västerås';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/11959430';
            $routeDetail->save();
