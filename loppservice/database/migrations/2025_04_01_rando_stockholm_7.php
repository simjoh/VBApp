...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->start_place = 'Scandic Hotell Nord';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/uppsala-300-km-7';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/uppsala-300-km-7/#gpx';
            $routeDetail->save();
