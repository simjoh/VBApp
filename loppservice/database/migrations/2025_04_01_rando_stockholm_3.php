    ...
    public function up(): void
    {
       // if (App::isProduction()) {
          ...
          //  $routeDetail->height_difference = ; // Hardcoded value in meters
            ...
            $routeDetail->start_place = 'Lövlundsgatan, Södertälje';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/sodertalje-9';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/sodertalje-9/#gpx';
            $routeDetail->save();
