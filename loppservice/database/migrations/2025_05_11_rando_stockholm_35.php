...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'ab6f2877-d356-4aae-8a78-f19f4a814fcb'; // Make sure this is unique
            $event->title = 'Täby 600 Bryggerirunda';
            $event->description = '';
            $event->startdate = '2025-07-19';
            ...
            $eventconfiguration->registration_closes = '2025-07-18 05:00:00';
            ...
            $routeDetail->height_difference = 4126; // Hardcoded value in meters
            $routeDetail->start_time = '07:00';
            $routeDetail->start_place = 'Circle K, Kemistvägen 2';
            $routeDetail->pay_link = 'Swish 123 361 00 86';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50253398';
            $routeDetail->save();
