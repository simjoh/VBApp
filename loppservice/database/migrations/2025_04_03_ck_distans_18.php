...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Jönköping';
            $event->description = '';
            $event->startdate = '2025-08-30';
            $event->enddate = '2025-08-30';
            ...
            $eventconfiguration->registration_opens = '2025-08-29 00:00:00';
            $eventconfiguration->registration_closes = '2025-08-29 23:59:59';
            ...
            $routeDetail->height_difference = 2407; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/47682997';
            $routeDetail->save();
