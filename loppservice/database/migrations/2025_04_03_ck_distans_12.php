...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Jönköping';
            $event->description = '';
            $event->startdate = '2025-04-06';
            $event->enddate = '2025-04-06';
            ...
            $eventconfiguration->registration_opens = '2025-04-05 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-05 23:59:59';
            ...
            $routeDetail->height_difference = 2076; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48289359';
            $routeDetail->save();
