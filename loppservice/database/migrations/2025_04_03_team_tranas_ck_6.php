...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $eventconfiguration->registration_closes = '2025-05-16 23:59:00';
            ...
            $routeDetail->height_difference = 3614; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/40969698';
            $routeDetail->save();
