...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/sodertalje-10';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/sodertalje-10/#gpx';
            $routeDetail->save();
