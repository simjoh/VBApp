...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '854e3efb-0843-48be-8bbe-0d8b1e7e2433'; // Make sure this is unique
            ...
            $eventconfiguration->registration_closes = '2025-09-04 23:59:00';
            ...
            $routeDetail->height_difference = 1647; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50026168';
            $routeDetail->save();
