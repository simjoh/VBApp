...
return new class extends Migration
{
    ...
    public function up(): void
    {
        //if (App::isProduction()) {
            ...
            $event->title = 'BP 45 VÄSTERBOTTEN BREVET';
            $event->description = '';
            ...
            $routeDetail->distance = 45; // 200 km
            $routeDetail->height_difference = 192; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3274856415863260326';
            $routeDetail->save();
