...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 600 Jönköping';
            $event->description = '';
            $event->startdate = '2025-08-16';
            $event->enddate = '2025-08-16';
            $event->completed = false;
            $event->embedid = '';
            $event->event_type = 'BRM'; // BRM = Brevet Randonneurs Mondiaux

            // Step 2: Hardcode county ID (Jönköping)
            $event->county_id = 5; // Hardcoded county ID - change this later
            ...
            $eventconfiguration->registration_opens = '2025-08-15 00:00:00';
            $eventconfiguration->registration_closes = '2025-08-15 23:59:59';
            ...
            $routeDetail->distance = 600; // 200 km
            $routeDetail->height_difference = 4762; // Hardcoded value in meters
            $routeDetail->start_time = '06:00';
            $routeDetail->start_place = 'Circle K, Jönköping';
            $routeDetail->pay_link = 'Swish 1230236935' ;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48599075';
            $routeDetail->save();
