...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '2839debd-ac68-4e2f-84ea-16f121d1ba76'; // Make sure this is unique
            $event->title = 'Södertälje 600';
            $event->description = '';
            $event->startdate = '2025-05-24';
            $event->enddate = '2025-05-25';
            ...
            $eventconfiguration->registration_closes = '2025-05-23 06:00:00';
            ...
            $routeDetail->height_difference = 3489; // Hardcoded value in meters
            $routeDetail->start_time = '06:15';
            $routeDetail->start_place = 'Östertälje Pendeltågsstation';
            $routeDetail->pay_link = 'Swish 123 675 13 17';
	    $routeDetail->name = $event->title;

            // Simplified description without start time/place info
            $routeDetail->description = 'OBS! Start 06:15 från Östertälje!';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50636965';
            $routeDetail->save();
