...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '7142dfa2-c6d3-428e-b7c3-b9b138c585a7'; // Make sure this is unique
            $event->title = 'Täby 200 Lördagsgodis';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-03 08:59:59';
            ...
            $routeDetail->height_difference = 1485; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49572568';
            $routeDetail->save();
