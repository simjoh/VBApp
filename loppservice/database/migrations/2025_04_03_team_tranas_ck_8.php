...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 600 Tranås';
            $event->description = '';
            $event->startdate = '2025-06-03';
            $event->enddate = '2025-06-04';
            ...
            // Step 3: Hardcode organizer ID (Tranås CK)
            $event->organizer_id = 6; // Hardcoded organizer ID - change this later
            ...
            $eventconfiguration->registration_opens = '2025-06-02 00:00:00';
            $eventconfiguration->registration_closes = '2025-06-02 23:59:00';
            ...
            $routeDetail->height_difference = 5749; // Hardcoded value in meters
            $routeDetail->start_time = '07:00';
            $routeDetail->start_place = 'ICA Kvantum, Tranås';
            $routeDetail->pay_link = 'Swish 1230247650';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/41150597';
            $routeDetail->save();
