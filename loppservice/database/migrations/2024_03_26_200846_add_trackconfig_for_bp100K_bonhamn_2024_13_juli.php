...
return new class extends Migration {
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            $event = new Event();
            $event->event_uid = '44185dfa-8dc1-4b54-8ded-de2fb9b3e274';
            $event->title = "BP 100K BÖNHAMN - 13 Juli";
            $event->description = 'Startplats: Ullånger, OKQ8. Starttid: 11:00. Cykelintresset bjuder på avslutningsfika. 6 km grusväg.';
            $event->startdate = '2024-07-13';
            $event->enddate = '2024-07-13';
            $event->completed = false;
            $event->embedid = 3100753078499188558;
            ...
            $eventconfiguration->registration_closes = '2024-07-12 23:59:59';
            ...
            $event = new Event();
            $event->event_uid = 'e01aa6c2-dcc7-4ef1-b38f-79fddd987a0f';
            $event->title = "TEST - BP 100K BÖNHAMN - 13 Juli";
            $event->description = 'Startplats: Ullånger, OKQ8. Starttid: 11:00. Cykelintresset bjuder på avslutningsfika. 6 km grusväg.';
            $event->startdate = '2024-07-13';
            $event->enddate = '2024-07-13';
            $event->completed = false;
