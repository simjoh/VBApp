...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 400 Örebro Norra';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-23 21:00:00';
            ...
            $routeDetail->height_difference = 4874; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.alltrails.com/explore/map/orebro-400km-norra--2';
            $routeDetail->save();
