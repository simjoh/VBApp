...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'Sandviken 400';
            $event->description = '';
            $event->startdate = '2025-04-30';
            ...
            $routeDetail->start_time = '22:00';
            $routeDetail->start_place = 'Welcome hotell, Barkarby';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/barkarby-200-sandviken';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/barkarby-200-sandviken/#gpx';
            $routeDetail->save();
