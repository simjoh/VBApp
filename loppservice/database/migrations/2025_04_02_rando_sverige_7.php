...
return new class extends Migration
{
    ...
    public function up(): void
    {
      //  if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '43d0fd99-73c9-49b3-af9d-ffab4eb4682f';
            $event->title = 'BRM 200 Öströö fårfarm';
            $event->description = '';
            $event->startdate = '2025-04-26';
            $event->enddate = '2025-04-26';
            $event->completed = false;
            $event->embedid = '';
            $event->event_type = 'BRM'; // BRM = Brevet Randonneurs Mondiaux

            // Step 2: Hardcode county ID (Västra Götaland)
            $event->county_id = 12; // Hardcoded county ID - change this later

            // Step 3: Hardcode organizer ID (Randonneurs Sverige)
            $event->organizer_id = 9; // Hardcoded organizer ID - change this later
            ...
            $eventconfiguration->registration_closes = '2025-04-24 23:59:59';
            ...
            $routeDetail->height_difference = 1692; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Circle K, Fässbergsmotet';
            $routeDetail->pay_link = 'Plusgiro 692505-1';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/46166387';
            $routeDetail->save();
