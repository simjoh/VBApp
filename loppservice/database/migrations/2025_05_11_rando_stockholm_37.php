...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '2eec0f22-0f52-4442-97e0-60bffcd1da61'; // Make sure this is unique
            $event->title = 'Täby 300 Saltluft';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-08-29 06:00:00';
            ...
            $routeDetail->height_difference = 1400; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49430335';
            $routeDetail->save();
