...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'd62fc82c-5d09-4fe2-847a-65b1a4c3f902'; // Make sure this is unique
            $event->title = 'Barkarby 200 Järlåsa medsols';
            $event->description = '';
            $event->startdate = '2025-10-18';
            $event->enddate = '2025-10-18';
            ...
            $eventconfiguration->registration_closes = '2025-10-17 07:59:59';
            ...
            $routeDetail->height_difference = 2098; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50266030';
            $routeDetail->save();
