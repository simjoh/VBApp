...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BRM 600 Hjo tur och retur';
            $event->description = '';
            ...
            $routeDetail->height_difference = 4931; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/47602867';
            $routeDetail->save();
