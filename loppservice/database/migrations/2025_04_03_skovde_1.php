...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            // Step 3: Hardcode organizer ID (IOGT/NTO Skövde)
            $event->organizer_id = 7; // Hardcoded organizer ID - change this later
            ...
            $routeDetail->height_difference = 100; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Skövde';
            $routeDetail->pay_link = 'https://docs.google.com/forms/d/e/1FAIpQLScCnlNQzyNSqeAVfbP6zQJwjFV8IXQnUBt4sbutUqiGE9bhKA/viewform';
