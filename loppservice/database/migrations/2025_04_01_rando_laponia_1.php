...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            // Step 2: Hardcode county ID (Västernorrland)
            $event->county_id = 18; // Hardcoded county ID - change this later
            ...
            $eventconfiguration->use_stripe_payment = true;
            ...
            $routeDetail->height_difference = 3190; // Hardcoded value in meters
            $routeDetail->start_time = '11:00';
            $routeDetail->start_place = 'OKQ8, Ullånger';
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3100349179201448984';
            $routeDetail->save();
