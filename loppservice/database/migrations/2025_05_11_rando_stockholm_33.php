...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '6c05aa62-3ccd-447a-8bbd-36ff2905f76c'; // Make sure this is unique
            ...
            $eventconfiguration->registration_closes = '2025-07-04 06:00:00';
            ...
            $routeDetail->height_difference = 1618; // Hardcoded value in meters
