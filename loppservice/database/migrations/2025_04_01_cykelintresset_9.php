...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            // Step 3: Hardcode organizer ID (Cykelintresset)
            ...
            $routeDetail->height_difference = 4700; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3331728177651843806';
            $routeDetail->save();
