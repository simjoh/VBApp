...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '44177c0b-81e3-4148-91c6-69258473b083'; // Make sure this is unique
            $event->title = 'Täby 200 Försmak';
            $event->description = '';
            ...
            $routeDetail->height_difference = 1661; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49429684';
            $routeDetail->save();
