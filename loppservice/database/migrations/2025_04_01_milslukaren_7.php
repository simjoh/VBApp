...
return new class extends Migration
{
    ...
    public function up(): void
    {
      //  if (App::isProduction()) {
            ...
            $event->title = 'Mils200Åsa';
            $event->description = '';
            $event->startdate = '2025-09-20';
            $event->enddate = '2025-09-20';
            ...
            $routeDetail->height_difference = 1184; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Hyllie Stationstorg';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/38853742';
            $routeDetail->save();
