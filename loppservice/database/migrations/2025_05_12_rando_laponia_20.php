...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '08cb87b8-b35d-4eb2-b0e1-94d917d95ccb'; // Make sure this is unique
            $event->title = 'BRM 400 FREDRIKA';
            $event->description = '';
            ...
            $routeDetail->distance = 2; // 400 km
            $routeDetail->height_difference = 2884; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3376954724935416164';
            $routeDetail->save();
