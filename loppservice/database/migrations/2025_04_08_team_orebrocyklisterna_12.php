...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '7c857316-aabc-4fce-be6b-62c9e23a03ad'; // Make sure this is unique
            ...
            $eventconfiguration->registration_closes = '2025-05-15 06:00:00';
            ...
            $routeDetail->height_difference = 1767; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50032345';
            $routeDetail->save();
