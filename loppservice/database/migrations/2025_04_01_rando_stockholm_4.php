...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->start_place = 'Café Linné, Linnégatan';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/uppsala-200-km-9';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/uppsala-200-km-9/#gpx';
            $routeDetail->save();
