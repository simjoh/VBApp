...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->height_difference = 3237; // Hardcoded value in meters
            $routeDetail->start_time = '06:00';
            $routeDetail->start_place = 'Stadium Arena, Himmelstalund';
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/40065871';
            $routeDetail->save();
