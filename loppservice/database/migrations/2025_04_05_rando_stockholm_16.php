...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'fba4248e-75b1-4594-8481-6505b8f04563'; // Make sure this is unique
            $event->title = 'Täby 200 Söndagsbön';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-04 08:59:59';
            ...
            $routeDetail->height_difference = 1457; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/49572570';
            $routeDetail->save();
