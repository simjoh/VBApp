...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->distance = 100; // 200 km
            $routeDetail->height_difference = 1811; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3295081347510480908';
            $routeDetail->save();
