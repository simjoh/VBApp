...
return new class extends Migration
{
    ...
    public function up(): void
    {
      //  if (App::isProduction()) {
            ...
            $event->title = 'Södertörns Pärla 200';
            $event->description = '';
           ...
           // $routeDetail->height_difference // Hardcoded value in meters
            $routeDetail->start_time = '09:00';
            $routeDetail->start_place = 'Lövlundsgatan 6, Södertälje';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/sodertorns-parla-4/';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/sodertorns-parla-4/#gpx';
            $routeDetail->save();
