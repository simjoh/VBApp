...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '534be504-1ea1-4500-a561-cfe1f088523b'; // Make sure this is unique
            ...
            $eventconfiguration->registration_closes = '2025-05-17 08:59:59';
            ...
            $routeDetail->height_difference = 1194; // Hardcoded value in meters
