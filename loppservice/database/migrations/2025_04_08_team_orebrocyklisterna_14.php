...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'e13dbebc-d2a2-45c3-bc00-800dea81052c'; // Make sure this is unique
            $event->title = 'BRM 400 Örebro Södra';
            $event->description = '';
            ...
            $routeDetail->height_difference = 3158; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50057368';
            $routeDetail->save();
