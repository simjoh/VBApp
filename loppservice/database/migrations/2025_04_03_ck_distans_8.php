...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Torsby';
            $event->description = '';
            $event->startdate = '2025-05-10';
            $event->enddate = '2025-05-10';
            ...
            $eventconfiguration->registration_opens = '2025-05-08 00:00:00';
            $eventconfiguration->registration_closes = '2025-05-08 23:59:59';
            ...
            $routeDetail->height_difference = 2219; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/46530068';
            $routeDetail->save();
