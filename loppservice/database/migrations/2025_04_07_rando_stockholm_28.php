...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '5593e3cb-44a5-4b3e-8c06-ffd56162243e'; // Make sure this is unique
            $event->title = 'Barkarby 600 6 färjor';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-08-08 06:59:59';
            ...
            $routeDetail->height_difference = 8527; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->description = 'Hemlig kontroll efter Vingåker';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50266031';
            $routeDetail->save();
