...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BP 300 VÄSTERBOTTEN BREVET';
            $event->description = '';
            ...
            $routeDetail->height_difference = 2016; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3273612737869302100';
            $routeDetail->save();
