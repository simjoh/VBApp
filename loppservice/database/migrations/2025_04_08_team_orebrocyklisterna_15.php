...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '58d763ab-fc7f-4b10-9155-056a73699d10'; // Make sure this is unique
            $event->title = 'BRM 600 Örebro Södra';
            $event->description = '';
            $event->startdate = '2025-06-07';
            $event->enddate = '2025-06-08';
            ...
            $eventconfiguration->registration_closes = '2025-06-05 23:59:00';
            ...
            $routeDetail->height_difference = 4801; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50077348';
            $routeDetail->save();
