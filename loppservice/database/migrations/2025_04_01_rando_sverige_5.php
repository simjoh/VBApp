...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BRM 400 Halmstad';
            $event->description = '';
            $event->startdate = '2025-06-14';
            $event->enddate = '2025-06-14';
            ...
            $routeDetail->height_difference = 3150; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/39431334';
            $routeDetail->save();
