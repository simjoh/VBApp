...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Torpa stenhus';
            $event->description = '';
            ...
            $routeDetail->height_difference = 2348; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'Circle K Mölndal, Söderleden';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/46515232';
            $routeDetail->save();
