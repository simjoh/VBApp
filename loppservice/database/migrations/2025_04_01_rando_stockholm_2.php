...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $routeDetail->start_place = 'Welcome hotell i Barkarby';
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/barkarby-jarlasarundan';
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/barkarby-jarlasarundan/#gpx';
            $routeDetail->save();
