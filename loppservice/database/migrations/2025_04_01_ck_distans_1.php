...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            // Add this line to use the Str class
            $event->title = 'Smålandsflykt';
            $event->startdate = '2025-03-29';
            $event->enddate = '2025-03-29';
            $event->description = '';
            ...
            // Step 3: Hardcode organizer ID (CK Distans)
            $event->organizer_id = 12; // Hardcoded organizer ID - change this later
            ...
            $eventconfiguration->registration_closes = '2025-08-30 23:59:59';
            ...
            $routeDetail->height_difference = 1981; // Hardcoded value in meters
            $routeDetail->start_time = '08:00';
            $routeDetail->start_place = 'ICA Kvantum Klockaretorpet';
            $routeDetail->pay_link = 'https://ckdistans.wordpress.com/vasterasbreveter/norrkoping';
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/41107670';
            $routeDetail->save();

            // Step 9: Add event to a group (optional)
            // Hardcode event group UID
            // $event->event_group_uid = ''; // Hardcoded event group UID - change this later
            // $event->save();
       // }
    }
    ...
    {
        if (App::isProduction()) {
            // Find the event by title, startdate, and enddate
            $event = Event::where('title', 'Smålandsflykt')
                          ->where('startdate', '2025-03-29')
                          ->where('enddate', '2025-03-29')
                          ->first();
