...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '192e0153-92b9-4166-ab7e-6d34ceced6c0'; // Make sure this is unique
            $event->title = 'Bromma 600';
            $event->description = '';
            $event->startdate = '2025-08-29';
            $event->enddate = '2025-08-29';
            ...
            $eventconfiguration->registration_closes = '2025-08-29 20:59:59';
            ...
            $routeDetail->height_difference = 3502; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48473330';
            $routeDetail->save();
