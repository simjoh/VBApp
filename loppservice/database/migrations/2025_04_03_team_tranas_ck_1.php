...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $eventconfiguration->registration_opens = '2025-05-14 00:00:00';
            $eventconfiguration->registration_closes = '2025-05-14 23:59:00';
            ...
            $routeDetail->height_difference = 3615; // Hardcoded value in meters
