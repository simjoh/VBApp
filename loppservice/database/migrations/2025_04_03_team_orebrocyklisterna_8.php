...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Örebro Västra';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-09 21:00:00';
            ...
            $routeDetail->height_difference = 2262; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/2958371426194865694';
            $routeDetail->save();
