...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '406f2f22-7955-42b2-b691-adf5e39112e7'; // Make sure this is unique
            $event->title = 'Barkarby 200 Grus';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-16 07:59:59';
            ...
            $routeDetail->height_difference = 1914; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->description = 'OBS! Rutt med endast 24% asfalt.';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50325932';
            $routeDetail->save();
