...
return new class extends Migration
{
    ...
    public function up(): void
    {
      //  if (App::isProduction()) {
            ...
            $event->title = 'Östergötland XL';
            $event->description = '';
            $event->startdate = '2025-09-13';
            $event->enddate = '2025-09-13';
            ...
            $routeDetail->height_difference = 2679; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            // Hardcoded track linke5a5b805-0991-4c4b-a4b8-6b330d5d49af
            $routeDetail->track_link = 'https://ridewithgps.com/routes/44473469';
            $routeDetail->save();
