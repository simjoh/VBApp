...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'Bromma 200';
            $event->description = '';
            $event->startdate = '2025-04-27';
            $event->enddate = '2025-04-27';
            ...
            $routeDetail->pay_link = 'https://www.randonneurstockholm.se/events/bromma-200';
            ...
            $routeDetail->track_link = 'https://www.randonneurstockholm.se/events/bromma-200/#gpx';
            $routeDetail->save();
