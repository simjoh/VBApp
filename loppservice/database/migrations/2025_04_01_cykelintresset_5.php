...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BP 200 VÄSTERBOTTEN BREVET';
            $event->description = '';
            ...
            $routeDetail->height_difference = 1371; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3274852117827317922';
            $routeDetail->save();
