...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $existingEvent = Event::where('title', 'Skånelägret 300')
                ->where('startdate', '2025-05-17')
            ...
            if ($existingEvent) {
                Log::info('Migration skipped: Event "Skånelägret 300" on 2025-05-17 at 08:00 already exists.');
                return;
            }
            ...
            $event->title = 'Skånelägret 300';
            $event->description = '';
            $event->startdate = '2025-05-17';
            $event->enddate = '2025-05-17';
