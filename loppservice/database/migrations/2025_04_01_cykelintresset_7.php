...
return new class extends Migration
{
    ...
    public function up(): void
    {
       // if (App::isProduction()) {
            ...
            $event->title = 'BP 80 VÄSTERBOTTEN BREVET';
            $event->description = '';
            ...
            $routeDetail->distance = 80; // 200 km
            $routeDetail->height_difference = 548; // Hardcoded value in meters
	     ...
	     $routeDetail->name = $event->title;
            ...
            $routeDetail->track_link = 'https://www.strava.com/routes/3274855852927723686';
            $routeDetail->save();
