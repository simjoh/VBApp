...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Örebro Östra';
            $event->description = '';
            ...
            $eventconfiguration->registration_opens = '2025-04-24 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-24 21:00:00';
            ...
            $routeDetail->height_difference = 3161; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.alltrails.com/explore/map/orebro-200km-ostra';
            $routeDetail->save();
