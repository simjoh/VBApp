...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = '3d6cad24-e35b-4cd4-85ad-cf399767fc48'; // Make sure this is unique
            ...
            $eventconfiguration->registration_closes = '2025-07-03 23:59:00';
            ...
            $routeDetail->height_difference = 4914; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50111337';
            $routeDetail->save();
