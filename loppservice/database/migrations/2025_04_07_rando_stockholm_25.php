...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'b70ff7ec-4c5a-45e5-a56b-e6fbbc7aa4eb'; // Make sure this is unique
            $event->title = 'Barkarby 200 Glassrundan';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-06-27 07:59:59';
            ...
            $routeDetail->height_difference = 1213; // Hardcoded value in meters
	    ...
	    $routeDetail->name = $event->title;
            ...
            $routeDetail->description = 'Vid finväder äter vi glass på Svelato!';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50325929';
            $routeDetail->save();
