...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Örebro Södra';
            $event->description = '';
            ...
            $eventconfiguration->registration_opens = '2025-04-25 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-25 21:00:00';
            ...
            $routeDetail->height_difference = 4078; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://www.alltrails.com/explore/map/orebro-300km-sodra';
            $routeDetail->save();
