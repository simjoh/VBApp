...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event = new Event();
            $event->event_uid = 'ee765194-ea4f-45b8-ab2e-3bdee6e875fe'; // Make sure this is unique
            $event->title = 'Södertälje 1000';
            $event->description = '';
            $event->startdate = '2025-05-29';
            $event->enddate = '2025-06-02';
            ...
            $eventconfiguration->registration_closes = '2025-05-28 21:00:00';
            ...
            $routeDetail->height_difference = 10131; // Hardcoded value in meters
            $routeDetail->start_time = '21:00';
            $routeDetail->start_place = 'Lövlundsgatan 6, Södertälje';
            $routeDetail->pay_link = 'Swish 123 675 13 17';
	    $routeDetail->name = $event->title;

            // Simplified description without start time/place info
            $routeDetail->description = 'OBS! Kvällsstart 21:00.';

            // Hardcoded track link
            $routeDetail->track_link = 'https://ridewithgps.com/routes/50678722';
            $routeDetail->save();
