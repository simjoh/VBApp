...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 300 Tranås';
            $event->description = '';
            $event->startdate = '2025-05-03';
            $event->enddate = '2025-05-03';
            ...
            $eventconfiguration->registration_closes = '2025-05-02 23:59:00';
            ...
            $routeDetail->height_difference = 3328; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/37282005';
            $routeDetail->save();
