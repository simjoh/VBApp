...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Örebro Södra';
            $event->description = '';
            $event->startdate = '2025-04-12';
            $event->enddate = '2025-04-12';
            ...
            $eventconfiguration->registration_opens = '2025-04-10 00:00:00';
            $eventconfiguration->registration_closes = '2025-04-10 21:00:00';
            ...
            $routeDetail->height_difference = 2965; // Hardcoded value in meters
            $routeDetail->start_time = '-';
            $routeDetail->start_place = 'Idrottens hus, Karlsgatan 28';
            $routeDetail->pay_link = 'Swish 0733706312';
            ...
            $routeDetail->track_link = 'https://www.alltrails.com/sv-se/explore/map/orebro-200-km-sodra';
            $routeDetail->save();
