...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $eventconfiguration->registration_opens = '2025-05-29 00:00:00';
            $eventconfiguration->registration_closes = '2025-05-29 23:59:59';
            ...
            $routeDetail->height_difference = 3256; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/48600082';
            $routeDetail->save();
