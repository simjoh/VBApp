...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (App::isProduction()) {
            ...
            $event->title = 'BRM 200 Örebro Norra';
            $event->description = '';
            ...
            $eventconfiguration->registration_closes = '2025-05-08 21:00:00';
            ...
            $routeDetail->height_difference = 1390; // Hardcoded value in meters
            ...
            $routeDetail->track_link = 'https://ridewithgps.com/routes/36101639';
            $routeDetail->save();
