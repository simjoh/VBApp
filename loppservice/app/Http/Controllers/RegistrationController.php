    ...
    public function index(Request $request)
    {
        ...
        if ($eventType === 'BRM') {
            return view('registrations.brevet')->with(['showreservationbutton' => $reservationactive,
                ...
                'years' => range(date('Y'), 1950), 'registrationproduct' => $registration_product->productID, 'reservationproduct' => $reservationactive == false ? null : $resevation_product->productID, 'genders' => $this->gendersSv()]);
        }
        ...
        return view('registrations.show')->with(['showreservationbutton' => $reservationactive,
            ...
            'years' => range(date('Y'), 1950), 'registrationproduct' => $registration_product->productID, 'reservationproduct' => $reservationactive == false ? null : $resevation_product->productID, 'genders' => $this->gendersEn()]);
    }
