...
@Component({
  selector: 'brevet-prepare-acp-report-table',
  standalone: false,
  templateUrl: './prepare-acp-report-table.component.html',
  styleUrl: './prepare-acp-report-table.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PrepareAcpReportTableComponent implements OnInit {
