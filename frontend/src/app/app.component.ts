...
export class AppComponent implements OnInit{
  ...
  constructor(injector: Injector, private initiatedService: InititatedService, private authenticatedservice: AuthenticatedService, private svgcache: SvgService, private sanitizer: DomSanitizer) {
