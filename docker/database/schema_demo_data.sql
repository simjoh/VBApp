...
INSERT INTO `event`(`event_uid`, `title`, `start_date`, `end_date`, `active`, `canceled`, `completed`, `description`) VALUES ('dc03677a-51eb-4269-bce1-b7a6a15dd7b3','Testbana för skapa deltagare',STR_TO_DATE("07-08-23","%d-%m-%y"),STR_TO_DATE("07-08-23","%d-%m-%y"),false,false,false,'TEST skapa deltagare');
...
INSERT INTO `event_tracks`(`track_uid`, `event_uid`) VALUES ('c9dd3c38-6860-4a0d-bfed-eebff6b8b8a1','dc03677a-51eb-4269-bce1-b7a6a15dd7b3');
...
INSERT INTO `checkpoint`(`checkpoint_uid`, `site_uid`, `title`, `description`, `distance`, `opens`, `closing`) VALUES ('6af9f3c5-d9c4-4bb0-959b-8d3700a1bf85','47e2e397-872a-49f9-8f5b-069d09f5855c','Test 1','DEMO',33, TIME("2021-06-15 09:00:00"),("2021-06-15 10:00:00"));
-- En kontroll rödtjärn
INSERT INTO `checkpoint`(`checkpoint_uid`, `site_uid`, `title`, `description`, `distance`, `opens`, `closing`) VALUES ('614e66c9-9d83-4144-b7f8-4effd01386f9','e53d8d51-c5e1-4d25-a8d3-afe0646c1f13','Test 2','DEMO',60, TIME("2021-06-15 11:00:00"),TIME("2021-06-15 12:30:00"));
-- Mål broparken
INSERT INTO `checkpoint`(`checkpoint_uid`, `site_uid`, `title`, `description`, `distance`, `opens`, `closing`) VALUES ('b340120e-f031-4040-bc86-4145fb74cd29 ','8a13602-83dc-447d-a85f-13b943e23a42','Test 3','DEMO',86, TIME("2021-06-15 08:00:00"),TIME("2021-06-15 09:00:00"));
...
-- Koppling testbana
INSERT INTO `track_checkpoint`(`track_uid`, `checkpoint_uid`) VALUES ('c9dd3c38-6860-4a0d-bfed-eebff6b8b8a1','6af9f3c5-d9c4-4bb0-959b-8d3700a1bf85');
INSERT INTO `track_checkpoint`(`track_uid`, `checkpoint_uid`) VALUES ('c9dd3c38-6860-4a0d-bfed-eebff6b8b8a1','614e66c9-9d83-4144-b7f8-4effd01386f9');
INSERT INTO `track_checkpoint`(`track_uid`, `checkpoint_uid`) VALUES ('c9dd3c38-6860-4a0d-bfed-eebff6b8b8a1','b340120e-f031-4040-bc86-4145fb74cd29 ');
